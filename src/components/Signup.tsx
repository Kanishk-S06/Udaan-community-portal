...
// import facebook from "../assets/facebook.png" // Removed
import { signInWithEmailAndPassword, signInWithPopup } from "firebase/auth"
import { auth, googleProvider } from "../firebase/setup" // Removed facebookProvider
    ...
    <>
      ...
      <div style={{ backgroundImage: `url(${background})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "100vh" }}
        ...
        <div className="bg-white h-11/12 w-7/12 rounded-sm p-8">
          <h1 className="text-blue-700 text-6xl font-bold font-serif text-center">UDAAN</h1>
          <h1 className="text-center font-bold text-black-500 mt-3">Building a brighter tomorrow, TODAY</h1>
          <div className="flex mt-10">
            <div>
              <h1 className="text-zinc-400 text-sm w-72">By continuing you indicate that you agree to UDAAN's
            ...
            <div className="ml-16">
              ...
              <div className="flex mt-4">
                ...
                <button onClick={login} className="bg-blue-700 text-white p-2 w-20 ml-24 rounded-full">Login</button>
              </div>
            </div>
          </div>
          <hr className="mt-3" />
          <h1 className="text-sm text-center mt-3 text-zinc-600">About . Careers . Privacy . Terms . Contact . Languages . Your . Ad . Choices . Press© UDAAN, Inc. 2024</h1>
        </div>
